    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Beancoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  beancoind [options]                     " + "\n" +
                  "  beancoind [options] <command> [params]  " + _("Send command to -server or beancoind") + "\n" +
                  "  beancoind [options] help                " + _("List commands") + "\n" +
                  "  beancoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: beancoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Beancoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Beancoin is probably already running."), strDataDir.c_str()));
